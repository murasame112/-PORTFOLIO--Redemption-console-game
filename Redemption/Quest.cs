...
namespace Redemption
{
    public class Quest
    {
        ...
        {
            /*
            {Imię}, the Paladin. On the one hand, you find the sound of it pretty proud... but on the other, in your brotherhood it doesn't really mean anything. All these noble knights have their own titles, for which they are known - like master Buzan the Fearless, master Aurrius the Pure or lieutenant Guts the Dragonslayer. Getting a honorary title from the grandmaster means, that you have achieved something worth remembering - therefore, being just "the Paladin" equals not being worthy of any attention. 
            And yet, you will change that state of affairs pretty soon. You've been traveling for the last week to reach Reefsville - small town, somewhere on the kingdom's borderland. It has been known for quite long, since any caravan has't returned from it's forest for a months. Merchants are terrified and have to travel through mountains, where bad weather doesn't allow any fragile goods to survive more than a day.
